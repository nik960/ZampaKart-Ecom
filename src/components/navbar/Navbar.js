      ...
      <div className="navbar">
        ...
        <div className={isSidebar ? "sidebar-active" : "sidebar-section"}>
          <div className="sideBar-cont">
            ...
            <div className="nav-social-links">
              ...
              <a href="https://www.instagram.com/kashyap_nikhil1/">
                <img src="/images/instagram.png" alt="insta" />
              </a>
              <a href="https://www.linkedin.com/in/nikhil-kumar-881723151/">
                <img src="/images/linkedin.png" alt="linkedin" />
              </a>
              <a href="https://github.com/nik960/">
        ...
        <div className="nav-menu">
          ...
          <div className="nav-menu-help">
            NEED HELP ?<span>123-456-789</span>
          </div>
        </div>
