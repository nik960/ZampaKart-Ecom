...
const Footer = () => {
    return (
        <>
            ...
            <div className="footer-sec-cont">
                <div className="footer-data-sec">
                    <div className="data-cont">
                        <div className="data-cont-head">ZampaKart</div>
                        <span>About Us</span>
                    ...
                    <div className="data-cont">
                        ...
                        <span>Payments And Returns</span>
                        <span>FAQs</span>
                    </div>
                </div>
                <div className="footer-news-letter">
                <div className="data-cont-head">Subscribe To Our Newsletters</div>
                <span>Get instant updates about our new products</span>
            ...
            © 2022 -ZampaKart : Of Fashion For Fashion To Fashion
